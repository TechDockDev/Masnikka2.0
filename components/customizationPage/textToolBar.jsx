...
import { Box, Button, FormControl, InputLabel, Menu, MenuItem, Select, Stack } from "@mui/material";

const TextToolBar = ({clone,toggleLayer,flipX,flipY, removeSelectedObject,bold,italic,underline,strike, changeColor, handleFontChange}) => {
